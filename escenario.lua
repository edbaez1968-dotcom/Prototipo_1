...
function CrearEscenario()
    arbol_izquierdo = Estructuras:Nuevo(6, 144/2, "img/ArbolTronco.png", tag_arbol_izq, 0.75, 1)
    arbol_derecho = Estructuras:Nuevo(154, 144/2, "img/ArbolTronco.png", tag_arbol_der, 0.75, 1)
    suelo_bosque = Estructuras:Nuevo(160/2, 140, "img/SueloBosque.png", tag_suelo, 1, 1)
    
    rama_central = Estructuras:Nuevo(ventana.ancho/2, ventana.alto/2, "img/RamaFlotante.png", tag_rama, 0.30, 0.50)
    rama_superior_izq = Estructuras:Nuevo(35, 35, "img/RamaFlotante.png", tag_rama, 0.25, 0.50)
    rama_superior_der = Estructuras:Nuevo(125, 35, "img/RamaFlotante.png", tag_rama, 0.25, 0.50)
    rama_inferior_izq = Estructuras:Nuevo(35, 105, "img/RamaFlotante.png", tag_rama, 0.25, 0.50)
    rama_inferior_der = Estructuras:Nuevo(125, 105, "img/RamaFlotante.png", tag_rama, 0.25, 0.50)
    
    hongo_izq = Estructuras:Nuevo(70, 70, "img/HongoGigante.png", tag_hongo, 0.20, 0.40)
    hongo_der = Estructuras:Nuevo(90, 70, "img/HongoGigante.png", tag_hongo, 0.20, 0.40)
end
